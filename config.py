...
class Config:
    ...
    STOP_LIST = ['Формовщик теста', 'тестомес', 'Тестомес', 'Тестовод',
                 'Пекарь-тестомес', 'Пекарь/тестовод', 'Тестодел', 'тестовода'
                 'тестоприготовления', 'тесторазделочных', 'пекарь', 'Буханка',
                 ...
                 'Специалист в отдел тестирования крупной техники',
                 'Стажер в центр сборки и тестирования техники',
                 'Стажер/тестировщик/разработчик в сервисный центр',
                 'Стажер по тестированию и ремонту',
                 ...
                 'ИП Дмитриев Александр Петрович', '"id": "FIELD_WORK"'
                 ]
