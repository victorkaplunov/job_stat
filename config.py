...
class Config:
    ...
    STOP_LIST = ['Формовщик теста', 'тестомес', 'Тестомес', 'Тестовод',
                 'Пекарь-тестомес', 'Пекарь/тестовод', 'Повар Тестодел',
                 'Оператор автоматизированной системы тестоприготовления',
                 ...
                 'Тестировщик бытовой техники', 'Тестировщик женских сумок',
                 'мастер-тестировщик',
                 ...
                 'FixItRight', 'Дмитриев Александр Петрович',
                 'Тестировщик устройств Apple', 'Тестировщик компьютерной техники/ Оптимизация и ремонт',
